		...
		private static function doMouseMove(event:MouseEvent):void{
			...
			if(resizeObj == null){
				...
				if(xPosition >= (point.x + thisObj.width - mouseMargin) && yPosition >= (point.y + thisObj.height - mouseMargin)){
					changeCursor(ButtonIcon.LEFT_OBLIQUE_SIZE, -6, -6); 
					...
					changeCursor(ButtonIcon.RIGHT_OBLIQUE_SIZE, -6, -6);
					...
					changeCursor(ButtonIcon.HORIZONTAL_SIZE, -9, -9);
					...
					changeCursor(ButtonIcon.VERTICAL_SIZE, -9, -9);
