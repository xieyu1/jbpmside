package cn.org.jbpmside.demo.action.task;
...
public class JbpmTaskAction {
    ...
    private static final Log log = LogFactory.getLog(JbpmTaskAction.class);
    ...
    public String processCompletedList() {
        ...
        page.setPageSize(DEFAULT_PAGE_SIZE);
        page.setCurrentPage(getIntCurrentPageNum());
        log.debug("the CurrentPageNum is "+getIntCurrentPageNum());
