    ...
    <body>
                ...
                <td background="/jbpmside/images/red_BODY_bg.gif"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><table height="23"  border="0" cellpadding="1" cellspacing="1" bgcolor="#9F6666">
                                    <tr align="center">
                                        <td width="82" bgcolor="#FFFFFF" class="Column_blue">办结列表</td>
                                    </tr>
                            </table></td>
                        </tr>
                </table></td>
        ...
        <table width="94%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <select id="chooseUser" name="chooseUser" onchange="gotoProcessCompletedList(this)">
                    ...
                    <table width="100%" height="15"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                ...
                                <a href="/jbpmside/processCompletedList.action?currentpagenum=1"> 第1页 </a>
                                <a href="/jbpmside/processCompletedList.action?currentpagenum=2"> 第2页 </a>
                                <a href="/jbpmside/processCompletedList.action?currentpagenum=3"> 第3页 </a>
                                <a href="/jbpmside/processCompletedList.action?currentpagenum=4"> 第4页 </a>
                                <a href="/jbpmside/processCompletedList.action?currentpagenum=5"> 第5页 </a>
                            </td>
                        </tr>
                    </table>
                </td>
